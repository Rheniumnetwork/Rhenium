...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Rhenium server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Rhenium features */
        {"Rhenium", "masternode", &masternode, true, true, false},
        {"Rhenium", "listmasternodes", &listmasternodes, true, true, false},
        {"Rhenium", "getmasternodecount", &getmasternodecount, true, true, false},
        {"Rhenium", "masternodeconnect", &masternodeconnect, true, true, false},
        {"Rhenium", "masternodecurrent", &masternodecurrent, true, true, false},
        {"Rhenium", "masternodedebug", &masternodedebug, true, true, false},
        {"Rhenium", "startmasternode", &startmasternode, true, true, false},
        {"Rhenium", "createmasternodekey", &createmasternodekey, true, true, false},
        {"Rhenium", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"Rhenium", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"Rhenium", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"Rhenium", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"Rhenium", "getmasternodescores", &getmasternodescores, true, true, false},
        {"Rhenium", "mnbudget", &mnbudget, true, true, false},
        {"Rhenium", "preparebudget", &preparebudget, true, true, false},
        {"Rhenium", "submitbudget", &submitbudget, true, true, false},
        {"Rhenium", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"Rhenium", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"Rhenium", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"Rhenium", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"Rhenium", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"Rhenium", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"Rhenium", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Rhenium", "checkbudgets", &checkbudgets, true, true, false},
        {"Rhenium", "mnsync", &mnsync, true, true, false},
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Rheniumd, or the -server option to Rhenium-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Rhenium-cli " + methodname + " " + args + "\n";
}
