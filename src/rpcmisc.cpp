...
<<<<<<< HEAD
            ...
            "  \"zXRHsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zXRH denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zXRH denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zXRH denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zXRH denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zXRH denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zXRH denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zXRH denomination\n"
...
>>>>>>> 3cb3aa92098e45afdbb5a3121b74b2ebf7e1705e
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in Rhenium/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in Rhenium/kb\n"
...
<<<<<<< HEAD
    ...
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zRheniumObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
...
Value validateaddress(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"Rheniumaddress\"\n"
            "\nReturn information about the given Rhenium address.\n"
            "\nArguments:\n"
            "1. \"Rheniumaddress\"     (string, required) The Rhenium address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"Rheniumaddress\", (string) The Rhenium address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: Rhenium address and we have full public key:
...
Value createmultisig(const Array& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are Rhenium addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) Rhenium address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
Value verifymessage(const Array& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"Rheniumaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"Rheniumaddress\"  (string, required) The Rhenium address to use for the signature.\n"
