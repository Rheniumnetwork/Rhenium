/* src/config/Rhenium-config.h.  Generated from Rhenium-config.h.in by configure.  */
/* src/config/Rhenium-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define this symbol if you have MSG_XRHIGNAL */
/* #undef HAVE_MSG_XRHIGNAL */
...
#define PACKAGE_BUGREPORT "www.Rhenium.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Rhenium Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Rhenium Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Rhenium"
