...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 5110;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // Rhenium starting difficulty is 1 / 2^12
<<<<<<< HEAD
...
>>>>>>> 3cb3aa92098e45afdbb5a3121b74b2ebf7e1705e
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // Rhenium: 
        nTargetSpacing = 1 * 60;  // Rhenium: 1 minute
<<<<<<< HEAD
        nMaturity = 9;
        ...
        nZerocoinStartHeight = 75000;
        nAccumulatorStartHeight = 1;
        nZerocoinStartTime = 1528387539; //  Thursday, 7 June 2018 16:05:39 - (Still requires block 75000)
...
>>>>>>> 3cb3aa92098e45afdbb5a3121b74b2ebf7e1705e
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "Final sum for Brexit divorce bill shrouded in uncertainty - 22 APRIL 2018'";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1524416833;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 854014;
...
>>>>>>> 3cb3aa92098e45afdbb5a3121b74b2ebf7e1705e
        ...
        assert(hashGenesisBlock == uint256("0x000004b3b3ca2f8aff1f0a902f2efaf61a4c02ff761b0d4843bc145484ab6034"));
        assert(genesis.hashMerkleRoot == uint256("0x1865086b69725389f28ae5845cc7d4e165f5cefc42b1aef6fb8190e82965a18c"));
		
		vSeeds.push_back(CDNSSeedData("seeds.rhenium.org", "seeds.rhenium.org")); // Seeder
...
=======
        strCoinMixingPoolDummyAddress = "RhenEXjDK5AiCAq4hofpBz2dqawfnEsPem";
        nStartMasternodePayments = 1403728576; //Wed, 25 Jun 2014 20:36:16 GMT
>>>>>>> 3cb3aa92098e45afdbb5a3121b74b2ebf7e1705e
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Rhenium: 1 day
        nTargetSpacing = 1 * 60;  // Rhenium: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
...
>>>>>>> 3cb3aa92098e45afdbb5a3121b74b2ebf7e1705e
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet Rhenium addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet Rhenium script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet Rhenium BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Rhenium BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Rhenium BIP44 coin type is '1' (All coin's testnet default)
...
>>>>>>> 3cb3aa92098e45afdbb5a3121b74b2ebf7e1705e
        ...
        nMinerThreads = 1;
<<<<<<< HEAD
        nTargetTimespan = 24 * 60 * 60; // Rhenium: 1 day
        nTargetSpacing = 1 * 60;        // Rhenium: 1 minutes
