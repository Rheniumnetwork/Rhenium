...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Rhenium Core Rhenium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Rhenium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Rhenium transaction") + "\n" +
                               "  Rhenium-tx [options] -create [commands]   " + _("Create hex-encoded Rhenium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Rhenium transaction
