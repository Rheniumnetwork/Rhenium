...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::XRH);
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in Rhenium.cpp during shotdown to also remove the window positions
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case AnonymizeRheniumAmount:
            ...
            emit anonymizeRheniumAmountChanged(nAnonymizeRheniumAmount);
            break;
        case CoinControlFeatures:
