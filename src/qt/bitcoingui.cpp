                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Rhenium Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Rhenium address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Rhenium: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXRH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Rhenium Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rhenium Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rhenium"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rhenium addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rhenium addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagRheniumtic information"));
    ...
    openAction->setStatusTip(tr("Open a Rhenium: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rhenium Core help message to get a list with possible Rhenium command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Rhenium Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rhenium network", "", count));
}
...
{
    QString strTitle = tr("Rhenium Core"); // default title
