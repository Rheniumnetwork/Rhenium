...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Rhenium is not connected
...
<<<<<<< HEAD
    RPC_WALLET_PASSXRHASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
=======
