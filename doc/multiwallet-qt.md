...
In order to support loading of multiple wallets in Rhenium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Rhenium.cpp.
...
Changes to Rhenium.cpp
----------------------
Rhenium.cpp is the entry point into Rhenium-qt, and as such, will require some minor modifications to provide hooks for
