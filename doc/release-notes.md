...
Rhenium Core version *version* is now available from:

  <https://github.com/eastcoastcrypto/Rhenium/releases>

Please report bugs using the issue tracker at github:

  <https://github.com/eastcoastcrypto/Rheniumita/issues>
...
If you are running an older version, shut it down. Wait until it has completely shut down (which might take a few minutes for older versions), then run the installer (on Windows) or just copy over /Applications/Rhenium-Qt (on Mac) or Rheniumd/Rhenium-qt (on Linux).
=======
Rhenium Core version 2.3.0 is now available from:

  <https://github.com/Rhenium-project/Rhenium/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/Rhenium-project/Rhenium/issues>
>>>>>>> 3cb3aa92098e45afdbb5a3121b74b2ebf7e1705e

Compatibility
==============

Rhenium Core is extensively tested on multiple operating systems using
...
Rhenium Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    winner: {
        address: addr,    (string) Rhenium MN Address,
...
[
  {
    ...
    "addr": addr,      (string) Masternode Rhenium address
...
Rhenium Core now enables bloom filters by default to support SPV clients like mobile wallets. This feature can be disabled by using the `-peerbloomfilters` option on startup.
...
- #195 `aee05fe` [ZMQ] ZMQ integration for Rhenium (Mrs-X)
...
### Tests and QA
- #191 `3a778c3` [Tests] Fix the unit test suite for use with Rhenium (Fuzzbawls)
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/Rhenium-project-translations/).
>>>>>>> 3cb3aa92098e45afdbb5a3121b74b2ebf7e1705e
