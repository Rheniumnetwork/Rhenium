Contributing to Rhenium Core
============================

The Rhenium Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Rhenium Core project, and is not to be
confused with overall Rhenium Network Protocol consensus changes.

Whether a pull request is merged into Rhenium Core rests with the project merge
...
Patches that change Rhenium consensus rules are considerably more involved than
...
Where a patch set proposes to change the Rhenium consensus, it must have been
...
The project leader is the release manager for each Rhenium Core release.
