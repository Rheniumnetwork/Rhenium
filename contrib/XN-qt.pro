...
RESOURCES += src/qt/Rhenium.qrc src/qt/Rhenium_locale.qrc

TRANSLATIONS += src/qt/locale/Rhenium_bg.ts \
                src/qt/locale/Rhenium_de.ts \
                src/qt/locale/Rhenium_en.ts \
                src/qt/locale/Rhenium_es.ts \
                src/qt/locale/Rhenium_fi.ts \
                src/qt/locale/Rhenium_fr.ts \
                src/qt/locale/Rhenium_it.ts \
                src/qt/locale/Rhenium_ja.ts \
                src/qt/locale/Rhenium_pl.ts \
                src/qt/locale/Rhenium_pt.ts \
                src/qt/locale/Rhenium_ru.ts \
                src/qt/locale/Rhenium_sk.ts \
                src/qt/locale/Rhenium_sv.ts \
                src/qt/locale/Rhenium_vi.ts \
                src/qt/locale/Rhenium_zh_CN.ts \
                src/qt/locale/Rhenium_zh_TW.ts
